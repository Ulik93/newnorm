...
const AboutUs = () => {
  return (
    <div className="aboutus__container">
      <p>
        Миссия “Группы компаний “Новая Норма” заключается в разработке и
        интегрировании программных решений информационных систем, продвижении
        современных технических решений для цифрового экономического развития
        Кыргызстана.
      </p>
      ...
      <ul className="aboutus__list">
        ...
        <li>
          внедрение системы цифровой маркировки товаров средствами
          идентификации;
        </li>
        <li>электронный документооборот;</li>
        <li>производственное оборудование для цифровой маркировки;</li>
        <li>автоматизация на 1С;</li>
        <li>развитие IT-образования.</li>
      </ul>
      <p>
